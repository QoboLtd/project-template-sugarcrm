...
<div id="search">
    <form name='UnifiedSearch' onsubmit='return SUGAR.unifiedSearchAdvanced.checkUsaAdvanced()'>
        ...
        <img id="unified_search_advanced_img" src="themes/Qobo/images/searchMore.gif" border="0" alt="{$APP.LBL_SEARCH}">&nbsp;
        <input type="text" name="query_string" id="query_string" size="20" value="{$SEARCH}" placeholder="Search">&nbsp;
        </form>
