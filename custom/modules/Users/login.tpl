	...
	<tr>
		...
		<div class="loginBoxShadow" style="width: 460px;">
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
				<tr>
					<td align="center"><!--<b>{sugar_translate module="Users" label="LBL_LOGIN_WELCOME_TO"}</b><br>-->
					    {$LOGIN_IMAGE}
					</td>
				</tr>
				<tr>
					<td align="center">
						<div class="login">
							<form action="index.php" method="post" name="DetailView" id="form" onsubmit="return document.getElementById('cant_login').value == ''">
                                ...
                                {/if}
									<tr>
										<td scope="row" width="28%" class="log_label"><label for="user_name">{sugar_translate module="Users" label="LBL_USER_NAME"}</label></td>
										<td width="72%"><input type="text" size='35' tabindex="1" id="user_name" name="user_name"  value='{$LOGIN_USER_NAME}' /></td>
									</tr>
									<tr>
										<td scope="row" width="28%" class="log_label"><label for="user_password">{sugar_translate module="Users" label="LBL_PASSWORD"}</label></td>
										<td width="72%"><input type="password" size='26' tabindex="2" id="user_password" name="user_password" value='{$LOGIN_PASSWORD}' /></td>
									</tr>
										...
										<div  style="cursor: hand; cursor: pointer; display:{$DISPLAY_FORGOT_PASSWORD_FEATURE};" onclick='toggleDisplay("forgot_password_dialog");'>
											...
											<div id="forgot_password_dialog" style="display:none" >
												...
												<table cellpadding="0" cellspacing="2" border="0" align="center" width="100%" >
													...
													<tr>
														<td scope="row" width="28%" class="log_label"><label for="fp_user_name">{sugar_translate module="Users" label="LBL_USER_NAME"}</label></td>
														<td width="72%"><input type="text" size='26' id="fp_user_name" name="fp_user_name"  value='{$LOGIN_USER_NAME}' /></td>
													</tr>
													<tr>
											            <td scope="row" width="28%" class="log_label"><label for="fp_user_mail">{sugar_translate module="Users" label="LBL_EMAIL"}</label></td>
											            <td width="72%"><input type="text" size='26' id="fp_user_mail" name="fp_user_mail"  value='' ></td>
											     	</tr>
													{$CAPTCHA}
													<tr>
													    <td scope="row" width="28%"><div id='wait_pwd_generation'></div></td>
														<td width="72%"><input{* title="Email Temp Password"*} class="button" type="button" style="display:inline" onclick="validateAndSubmit(); return document.getElementById('cant_login').value == ''" id="generate_pwd_button" name="fp_login" value="{sugar_translate module="Users" label="LBL_LOGIN_SUBMIT"}"></td>
													</tr>
												</table>
											</div>
										</td>
